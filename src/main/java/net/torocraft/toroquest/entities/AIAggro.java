...
public class AIAggro extends EntityAITarget
{
    ...
    public AIAggro(EntityCreature creatureIn, boolean entityCallsForHelpIn, Class<?>... excludedReinforcementTypes)
    {
    ...
    {
		if (entityLivingBaseIn instanceof EntityGuard)
		{
			return;
		}
