...
public class EntityAIToroMate extends EntityAIBase
{
    ...
    public EntityAIToroMate(EntityAnimal animal, double speedIn, EntityAnimal animalMate)
    {
        this(animal, speedIn, animalMate.getClass());
    }

    public EntityAIToroMate(EntityAnimal p_i47306_1_, double p_i47306_2_, Class <? extends EntityAnimal > p_i47306_4_)
    {
    ...
    private void spawnBaby()
    {
    	...
    	if ( rand.nextBoolean() )
    	{
    		cow = new EntityToroCow(world);
    	}
    	else
    	{
    		cow = new EntityToro(world);
    	}
        EntityAgeable entityageable = this.animal.createChild(cow);
