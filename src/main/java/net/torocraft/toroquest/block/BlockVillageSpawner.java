...
public class BlockVillageSpawner extends BlockContainer
{
    public static BlockVillageSpawner INSTANCE = new BlockVillageSpawner();

	public static final String NAME = "royalblock";
	...
	{
		GameRegistry.registerTileEntity(TileEntityVillageSpawner.class, ToroQuest.MODID + ":" + NAME);
	}
...
//	}
	...
	{
		return new TileEntityVillageSpawner();
	}
