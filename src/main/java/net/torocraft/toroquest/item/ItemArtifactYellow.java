...
public class ItemArtifactYellow extends ItemTrophy
{

	public static ItemArtifactYellow INSTANCE;
	public static final String NAME = "artifact_yellow";
	private static ResourceLocation REGISTRY_NAME = new ResourceLocation(ToroQuest.MODID, NAME);

	@SubscribeEvent
	public static void init(final RegistryEvent.Register<Item> event)
	{
		INSTANCE = new ItemArtifactYellow();
