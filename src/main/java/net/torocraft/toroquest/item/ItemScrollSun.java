...
public class ItemScrollSun extends ItemTownScroll
{
	public static final String SCROLL_NAME = "sun";
	public static ItemScrollSun INSTANCE;

	public ItemScrollSun(Province province)
	{
		super(province);
	...
	{
    	INSTANCE = new ItemScrollSun(null);
