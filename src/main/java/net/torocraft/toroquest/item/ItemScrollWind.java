...
public class ItemScrollWind extends ItemTownScroll
{
	public static final String SCROLL_NAME = "wind";
	public static ItemScrollWind INSTANCE;

	public ItemScrollWind(Province province)
	{
		super(province);
	...
	{
    	INSTANCE = new ItemScrollWind(null);
