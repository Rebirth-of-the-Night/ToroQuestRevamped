...
public class ItemScrollFire extends ItemTownScroll
{
	public static final String SCROLL_NAME = "fire";
	public static ItemScrollFire INSTANCE;

	public ItemScrollFire(Province province)
	{
		super(province);
	...
	{
    	INSTANCE = new ItemScrollFire(null);
