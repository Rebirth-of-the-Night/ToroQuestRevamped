...
public class ItemScrollMoon extends ItemTownScroll
{
	public static final String SCROLL_NAME = "moon";
	public static ItemScrollMoon INSTANCE;

	public ItemScrollMoon(Province province)
	{
		super(province);
	...
	{
    	INSTANCE = new ItemScrollMoon(null);
