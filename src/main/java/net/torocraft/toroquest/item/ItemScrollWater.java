...
public class ItemScrollWater extends ItemTownScroll
{
	public static final String SCROLL_NAME = "water";
	public static ItemScrollWater INSTANCE;

	public ItemScrollWater(Province province)
	{
		super(province);
	...
	{
    	INSTANCE = new ItemScrollWater(null);
