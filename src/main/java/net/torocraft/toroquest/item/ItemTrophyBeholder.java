...
public class ItemTrophyBeholder extends ItemTrophy
{

	public static ItemTrophyBeholder INSTANCE;
	public static final String NAME = "trophy_beholder";
